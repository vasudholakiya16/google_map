...
class CustomiseGoogleMap extends StatefulWidget {
  const CustomiseGoogleMap({super.key});

  @override
  State<CustomiseGoogleMap> createState() => _CustomiseGoogleMapState();
}

class _CustomiseGoogleMapState extends State<CustomiseGoogleMap> {
  String _mapTheme = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customise Google Map'),
        actions: [
